...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function searchByDate(){
				var myForm = document.getElementById("myForm");
				myForm.action = "searchClaimVoucher.action?type=newSearch";
	...
	<body>
		...
		<div class="search">                                      
            选择查询的日期：<input type="text" class="keywords"  id="time" name="claimVoucher.createTime"  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM'})" class="Wdate"/>
            <input type="button" value="查询" class="sub-search" onclick="return searchByDate()" />
   	 </div>
		<div class="main">
			<div class="global-width">
